...
def create_csv_template() -> str:
    ...
    lines = [
        "category,ticker,name,quantity,avg_price,currency,purchase_date",
        "emergency_fund,RDPU-SUCORINVEST,Sucorinvest Money Market Fund,12500000,1.0,IDR,2025-01-01",
        "id_stocks,BBCA.JK,Bank Central Asia,10,9500,IDR,2025-01-02",
        "us_stocks,NVDA,NVIDIA Corporation,0.5,140,USD,2025-01-02",
        "crypto,BTC,Bitcoin,0.001,1500000000,IDR,2025-01-02",
    ]
    return "\n".join(lines)
